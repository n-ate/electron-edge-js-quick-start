...
// const baseNetAppPath = path.join(__dirname, "/c-sharp/" + namespace + "/bin/Debug/net" + version + "3.1");
...
// var getRuntime = edge.func({
//     assemblyFile: baseDll,
//     typeName: localTypeName,
//     methodName: "GetCurrentRuntime",
// });

const quickStart = require("./app/utilities/QuickStart.cs.ts");
...
window.onload = function () {
    ...
    getRuntime("", function (error, result) {
        if (error) throw error;
        document.getElementById("GetRuntime").innerHTML = result;
    });
};
